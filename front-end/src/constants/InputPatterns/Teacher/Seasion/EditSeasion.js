/**
 * Input configuration patterns for editing existing course seasons by teacher
 * 
 * Defines the structure and validation rules for editing existing course seasons
 * Used by EditForm component to dynamically generate season edit form fields
 * 
 * @constant {Array<Object>} BASE_EDIT_SEASION_INPUT_PATTERN
 ...
 * @property {string} defaultValue - Default value populated from backend
 ...
 * - Default values are populated from backend for editing
 */
