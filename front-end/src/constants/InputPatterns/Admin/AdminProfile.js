/**
 * Input configuration patterns for admin profile editing
 * 
 * Defines the structure and validation rules for editing the currently logged-in admin's profile
 * Used by EditForm component to generate the form dynamically
 * Includes username, fullname, email, and phone number fields
 * 
 * @constant {Array<Object>} BASE_ADMIN_PROFILE_INPUT_PATTERNS - Array of input field configurations
 ...
 * 
 * @example
 * // Typical usage in EditForm for admin profile:
 * <EditForm
